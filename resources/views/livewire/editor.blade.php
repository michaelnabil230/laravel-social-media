    ...
    <div x-data="editorConfig($wire.entangle('body').defer, {{ $hasMentions }})" class="bg-white rounded-md {{ $hasShadow ? 'shadow-md' : '' }}">
        ...
        <div x-show="mode === 'write'">
            <div class="flex flex-col relative">
                ...
                <textarea
                    class="w-full h-full absolute left-0 top-0 right-0 bottom-0 overflow-y-hidden resize-none border-none p-5 focus:border focus:border-green300 focus:ring focus:ring-green200 focus:ring-opacity-50"
