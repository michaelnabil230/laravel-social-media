<div>
    <div class="md:flex md:items-center md:justify-between border-b border-gray-200 pb-4">
        <div class="flex-1 min-w-0">
            <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-4xl sm:truncate">
                ...
                <span class="text-2xl text-green-500 rounded-full bg-green-100 px-3">
                    {{ $notificationCount }}
                </span>
            </h2>
        </div>
    ...
    <x-modal identifier="markAllAsRead" :action="route('notifications.mark-as-read')" title="Confirm" type="post">
